...
class PKIHeader(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "generalInfo",
            univ.SequenceOf(componentType=InfoTypeAndValue())
...
class PKIBody(univ.Choice):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "ccr",
            CertReqMessages().subtype(
                explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 13)
            ),
        ),
        namedtype.NamedType(
            "ccp",
        ...
        namedtype.NamedType(
            ...
            CRLAnnContent().subtype(
                explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 18)
            ),
        ),
        namedtype.NamedType(
            "pkiconf",
        ...
        namedtype.NamedType(
            ...
            GenRepContent().subtype(
                explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 22)
            ),
        ),
        namedtype.NamedType(
            "error",
        ...
        namedtype.NamedType(
            ...
            CertConfirmContent().subtype(
                explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 24)
            ),
        ),
        namedtype.NamedType(
            "pollReq",
            PollReqContent().subtype(
                explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 25)
            ),
        ),
        namedtype.NamedType(
            "pollRep",
            PollRepContent().subtype(
                explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 26)
            ),
        ),
    )
...
class PKIMessage(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "extraCerts",
            univ.SequenceOf(componentType=CMPCertificate())
            .subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX))
