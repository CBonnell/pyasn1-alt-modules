...
class CertOrEncCert(univ.Choice):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "encryptedCert",
            rfc4211.EncryptedValue().subtype(
...
class CertifiedKeyPair(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "publicationInfo",
            rfc4211.PKIPublicationInfo().subtype(
                explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)
            ),
        ),
    )
...
class PKIBody(univ.Choice):
    ...
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "ir",
            rfc4211.CertReqMessages().subtype(
                explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)
            ),
        ),
        namedtype.NamedType(
        ...
        namedtype.NamedType(
            "p10cr",
            rfc6402.CertificationRequest().subtype(
